...
<!-- Website info ends here -->
	...
	<form action="<?php $_SERVER['PHP_SELF']; ?>"  method="POST" name="regForm" id="regForm"  class="form-horizontal">
				<fieldset>
				 <legend style="color:#A20F65; text-indent:12px;">New to Friendsalong? Sign up</legend>	
					<?php	
						  if ($err!='') {
...
<p style="text-indent:30px; font-family:sans-serif,arial;color:#5D1916; font-size:12px;">By clicking Sign Up, you agree to our <a rel="nofollow" target="_blank" href="terms">Terms</a> and that you have read our <a rel="nofollow" target="_blank" href="privacy">Data Privacy Policy</a>.</p>
...
>>>>>>> 273ee9fca5c9f54fd920c74860dfc5a45ddf32ec
</html>