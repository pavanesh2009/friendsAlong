...
t.train_name, t.date_of_journey, t.train_no, t.from_loc, t.to_loc
FROM users u
JOIN trains t ON u.user_id = t.user_id
...
{
?>
		<table class="table table-striped table-bordered" id="findtrainmate">
		<thead>			
