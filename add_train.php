...
<script type="text/javascript">
	...
	<!-- JAVASCRIPT -->	
	<script type="text/javascript" src="add_train.js"></script>
<div id="form">
<form id="add-train-form" action="javascript:alert('success!');" class="form-horizontal" onSubmit="return search_validate();">
				...
				<tr>
					<td>					
						...
						<label class="control-label" for="country_name">Country Name <span class="required"><font color="#CC0000">*</font></span></label>
							<div class="controls">
								<input type="text" class="emptyonclick" class="ac_input" name="country_name" id="query" placeholder="type a country name" autocomplete="off" delay="1500">
							</div>
					</div>
					</td>
					<td>					
		...
		<td>
			<div class="control-group">
				<label class="control-label" for="train_name">Train Name <span class="required"><font color="#CC0000">*</font></span></label>
					<div class="controls">
						<input type="text" class="emptyonclick" class="ac_input" name="train_name" id="query" placeholder="type your train name" autocomplete="off" delay="1500">
					</div>
			</div>					
		</td>
		<td>				
			<div class="control-group">
					<label class="control-label" for="train_no">Train No. <span class="required"><font color="#CC0000">*</font></span></label>
						<div class="controls">
						<input type="text" class="emptyonclick"  name="train_no" id="train_no" placeholder="type your train number"/>
						</div>
				</div>			
		</td></tr>
		<tr><td>		
					<div class="control-group">
						<label class="control-label" for="from_loc">From Location<span class="required"><font color="#CC0000">*</font></span></label>
							<div class="controls">
							<input type="text" class="emptyonclick" name="from_loc" id="from_loc" placeholder="enter from location"/>
							</div>
					</div>
			</td><td>	
					<div class="control-group">
						<label class="control-label" for="to_loc">To Location<span class="required"><font color="#CC0000">*</font></span></label>
							<div class="controls">
							<input type="text" class="emptyonclick" name="to_loc" id="to_loc" placeholder="enter to location"/>
							</div>
					</div>
			</td></tr>
		</table>
...
<div style="color:#943367; font-size:13px; font-family:'sans-serif', arial; text-indent:58px;"><span style="color:red">Note:</span>&nbsp;&nbsp;Please note <span style="color:#CC0000; font-size:16px;">*</span> marked fields are required &amp; train no. should contain at least four characters.</div>	
...
<script language="JavaScript">
	...
	//alert('coming');
	var i=1;
		for(i=1;i<=document.edittrainfrm.hdnCount.value;i++)
		{
			if(vol.checked == true)
			{
				eval("document.edittrainfrm.chkDel"+i+".checked=true");
			}
			else
			{
				eval("document.edittrainfrm.chkDel"+i+".checked=false");
			}
		}
	}
	function onDelete()
